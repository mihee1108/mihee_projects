...
<%@ include file="/template/header_mp.jsp"  %>
	...
	<section id = "center">
		...
		<section id="info">
			...
			<div id="info_list">
			<form action="noticeMod.notice" method="post" id="frm">
				
				<input type="hidden" name="curPage" value="${curPage}">
				<input type="hidden" name="num" value="${nDto.num}">
				<input type="hidden" name="b_cls" value="${nDto.b_cls}">
				<input type="hidden" name="writer" value="${nDto.writer}">
				<table id="t_write">
					<tr><td class="t_l">글 구분</td>
						<td class="t_r">
						<c:if test="${param.b_cls eq 'N'}">
						<select name="c_cls">
					...
					<tr><td class="t_l">제목</td>
						<td class="t_r"><input type="text" name="title" maxlength="500" value="${nDto.title}"></td></tr>
					<tr><td class="t_l">내용</td>
						<td class="t_r"><textarea id="contents" name="contents" class="contents">${nDto.contents}</textarea></td>
						
					<tr><td id="t_null" colspan="2"></td></tr>
					<tr><td class="t_l"></td><td class="t_r"><input type="button" id="btn_submit" class="btn_style" value="글 수정"></td></tr>
				</table>
			</form>
			</div>
		</section>
