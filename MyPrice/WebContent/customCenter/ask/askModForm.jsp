...
<%@ include file="/template/header_mp.jsp"  %>
	...
	<section id = "center">
		...
		<section id="info">
			<div id="info_image"><p>1:1문의 관리 - 수정</p></div>
			<div id="info_list">
			<form action="askMod.ask" method="post" id="frm">
				<input type="hidden" name="curPage" value="${curPage}">
				<input type="hidden" name="num" value="${aDto.num}">
				<input type="hidden" name="reply_date" value="${aDto.reply_date}">			
				<table id="t_write">
					...
					<tr><td class="t_l">이메일</td>
						<td class="t_r"><input type="text" id="email" name="email" size=30px value="${aDto.email}"></td></tr>
					...
					<tr><td id="t_null" colspan="2"></td></tr>
					<tr><td class="t_l"></td>
						<td class="t_r"><input type="button" id="btn_submit" class="btn_style" value="내용 수정"></td></tr>
				</table>
			</form>
			</div>
		</section>
